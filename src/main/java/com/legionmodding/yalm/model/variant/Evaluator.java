...
import info.openmods.calc.parsing.ast.*;
...
public class Evaluator
{
    ...
    private static class OperatorNot extends UnaryOperatorExpr implements NegatableOperator
    {
        ...
        public IExpr fold()
        {
            ...
            {
                return ((NegatableOperator)foldedArg).negation();
            }
    ...
    private static abstract class BinaryOperatorExpr implements IExpr
    {
        ...
        public final IExpr fold()
        {
            ...
            else
            {
                if (rightValue.isPresent())
                {
                    return fold(rightValue.get(), foldedLeft);
                }
            }

            if (foldedLeft.equals(foldedRight))
            {
                return foldSameExpr(foldedLeft);
            }
