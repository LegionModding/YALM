...
public class TexturedItemModelGeometry implements IModelGeometry<TexturedItemModelGeometry>
{
    ...
    public Collection<RenderMaterial> getTextures(IModelConfiguration owner, Function<ResourceLocation, IUnbakedModel> modelGetter, Set<Pair<String, String>> missingTextureErrors)
    {
        ...
        Set<RenderMaterial> result = Sets.newHashSet(modelGetter.apply(texturedModel).getMaterials(modelGetter, missingTextures));
        result.removeIf(r -> r.atlasLocation().equals(MissingTextureSprite.getLocation()));
        return result;
    }
    ...
    public IBakedModel bake(IModelConfiguration owner, ModelBakery modelBakery, Function<RenderMaterial, TextureAtlasSprite> spriteGetter, IModelTransform transform, ItemOverrideList overrides, ResourceLocation modelLocation)
    {
        ...
        final IBakedModel texturedBakedModel = modelBakery.getBakedModel(texturedModel, ModelRotation.X0_Y0, s -> spriteGetter.apply(new RenderMaterial(s.atlasLocation(), MissingTextureSprite.getLocation())));
